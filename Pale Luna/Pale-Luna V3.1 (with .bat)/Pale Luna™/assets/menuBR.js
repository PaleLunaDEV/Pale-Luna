...
function drawSupportMenu() {
    ...
    centerText("===========================================================================");
    centerText("-> Link para doação: https://the-last-deploy.itch.io/pale-luna");
    centerText("===========================================================================");
    centerText("[ABRIR?]");
    centerText("===========================================================================");
        ...
        case 'main':
            switch (selectedIndex) {
                ...
                case 4: // Créditos
                    ...
                    centerText("-> Agradecimentos especiais: Equipe do SENAI")
                    centerText("===========================================================================");
        ...
        case 'support':
            switch (selectedIndex) {
                case 0: // Sim
                    ...
                    exec('start https://the-last-deploy.itch.io/pale-luna');
                    await pausarParaContinuar();
                    drawMenu(mainMenuItems);
                    currentMenu = 'main';
                    break;
