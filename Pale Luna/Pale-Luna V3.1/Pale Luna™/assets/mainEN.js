...
centertext("===========================================================================")
centertext("PLEASE ADJUST THE TERMINAL WINDOW BEFORE STARTING THE GAME! IF YOU DON'T")
centertext("DOING THIS MAY CAUSE THE GAME TO HAVE INTERFACE PROBLEMS!")
pausarParaContinuar()
...
centertext("╚══════╝ ╚═════╝ ╚═╝  ╚═══╝╚═╝  ╚═╝");
centertext("===========================================================================")
centertext("--- ECHOES OF THE NIGHT - CREATED BY LUKZ (PaleLunaDev on X) ---")
centertext("===========================================================================")
centertext("--- VERSION 3.1 ---")
centertext("===========================================================================")
