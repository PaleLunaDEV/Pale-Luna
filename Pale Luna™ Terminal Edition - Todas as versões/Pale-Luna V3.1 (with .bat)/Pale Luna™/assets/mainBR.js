...
console.clear()
centertext("===========================================================================")
centertext("POR-FAVOR AJUSTE A JANELA DO TERMINAL ANTES DE INICIAR O JOGO! SE VOCÊ NÃO")
centertext("FIZER ISSO O JOGO PODE TER PROBLEMAS DE INTERFACE!")
pausarParaContinuar()
...
centertext("╚══════╝ ╚═════╝ ╚═╝  ╚═══╝╚═╝  ╚═╝");
centertext("===========================================================================")
centertext("--- EDIÇÃO DE TERMINAL - FEITO POR LUKZ (PaleLunaDev no X) ---")
centertext("===========================================================================")
centertext("--- VERSÃO 3.1 ---")
centertext("===========================================================================")
